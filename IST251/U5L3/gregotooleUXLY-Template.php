...
<p class="directions"><b>Unit X Lab Y: Name of the Lab.</b> Make sure you are able to understand
...
<p class="directions">Remember, you can learn a lot when you <a href="gregotooleUXLY.txt" title="View code" target="new">study the code</a>.
		
<p class="directions"><b>Example 5-x.</b> Description.</p>
